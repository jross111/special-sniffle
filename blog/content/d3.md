...
Without defining the `x` and `y` coordinates of multiple `svg` shapes, they will all appear at (0, 0)....on top of one another.  This example takes the previous example and spreads out all the bars.
